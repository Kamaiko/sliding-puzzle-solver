...
%  @arg State Liste de 9 éléments représentant le plateau 3x3
...
%  @arg State État initial à vérifier
%  @arg Goal État but (généralement position finale standard)
...
%  @arg State État à analyser
%  @arg Count Nombre d'inversions trouvées
...
%  @arg List Reste de la liste à traiter
%  @arg Acc Accumulateur du compte actuel
%  @arg Count Nombre total d'inversions
...
%  @arg State1 Premier état
%  @arg State2 Second état
...
%  @arg Position Position de la case vide (0-8)
...
%  @arg BlankPosition Position actuelle de la case vide (0-8)
%  @arg Direction Direction du mouvement (up/down/left/right)
%
...
%  @arg BlankPos Position actuelle de la case vide
%  @arg Direction Direction du mouvement
%  @arg TargetPos Position résultante après le mouvement
...
%  @arg State État initial
%  @arg Direction Direction du mouvement (up/down/left/right)
%  @arg NewState État résultant après le mouvement
...
%  @arg State État initial
%  @arg Pos1 Première position (0-8)
%  @arg Pos2 Seconde position (0-8)
%  @arg NewState État avec les tuiles échangées
...
%  @arg List Liste originale
%  @arg Index Index de l'élément à remplacer (0-based)
%  @arg Element Nouvel élément
%  @arg NewList Liste avec l'élément remplacé
